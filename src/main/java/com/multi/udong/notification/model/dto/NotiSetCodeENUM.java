...
public enum NotiSetCodeENUM {
    ...
    CL_SCHEDULE_REMIND("모임 일정 시작 알림", "{scheduleName}이 24시간 후에 시작됩니다.", "/club/schedule?scheduleNo="),
    ...
    RENT_RETURN_BORROWER("대여 물품 반납 알림(대여자)", "대여하신 물품 {itemName}의 반납 기한이 3일 후입니다.", "/rent/myRentals"),
    RENT_RETURN_OWNER("대여 물품 반납 알림(소유자)", "대여해주신 물품 {itemName}의 반납 기한이 3일 후입니다.", "/rent/myItems"),
    GIVE_DRAW_REMIND("나눔 물품 추첨 알림", "나눔하신 물품 {itemName}의 당첨자 추첨이 24시간 후에 진행됩니다.", "/give/detail?itemNo="),
